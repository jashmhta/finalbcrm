...
/**
 * Client-portal-route loading skeleton - mirrors the directory layout: a
 * header band, a KPI row, and a double-bezel table of skeleton rows. Streamed
 * instantly on navigation, before the force-dynamic `listClients()` query
 * against Neon resolves.
 */
export default function ClientPortalLoading() {
  return (
    <SkeletonPage eyebrow="Client portal" title="Clients" cards={0}>
